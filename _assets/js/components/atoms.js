var Atoms = (function ($) {
	...
	var _defineElements = function() {
		path1 = s.select('.js-atoms-line1');
		...
		atom1 = s.select('.js-atoms-atom1-line2');
	...
	var _defineAnimations = function() {
